...
export default function Home() {
  ...
  const [validation, setValidation] = useState<IFormValidate>({
    email: false,
    password: false,
  });
    ...
    <div className="min-h-screen flex flex-col items-center justify-center w-full dark:bg-gray-950">
      ...
      <div className="bg-white dark:bg-gray-900 shadow-md rounded-lg px-8 py-6 max-w-md">
        ...
        <form action={onLogin}>
          ...
          <button
            type="submit"
            className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-700 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
          >
            Login
          </button>
        </form>
